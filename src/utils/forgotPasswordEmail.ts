const forgotPasswordEmail = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
                  ...
                  <td style="padding: 40px 0px 0px;">
                    <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                      <div style="color: rgb(0, 0, 0); text-align: left;">
                        ...
                        <p style="padding-bottom: 16px"><a href="{{forgotPasswordLink}}" target="_blank"
                        ...
                        <p style="padding-bottom: 16px">Thanks,<br>The Auth team</p>
                      </div>
                    </div>
